  ...
  methods: {
    ...
    search() {
      ...
      axios({
        method: "get",
        url:
          "http://192.168.3.23:8081/user/selectUserByVagueName/" + searchContent,
      })
        .then((res) => {
          // 接收数据
          this.lists = res.data;
    ...
    retrieve(row) {
      ...
      axios({
        method:"get",
        url:"http://192.168.3.23:8081/user/selectBorrowHistory",
        params:{
    ...
    deleteById(row) {
      ...
      axios({
        method: "post",
        url: "http://192.168.3.23:8081/user/deleteUser/" + userId,
        // data() {
        //   userId : userId
        // },
    ...
    getLists() {
      axios({
        ...
        method: "get",
        //接口地址
        url: "http://192.168.3.23:8081/user/selectAllUser",
      })
        .then((res) => {
          //请求数据 res 返回的数据
          console.log(res);
