<template>
  <div class="home-container">
    <div class="login box">
      <img src="/img/home/userIcon.png" alt="" class="home-img" @click="toLogin" />
      <p class="logo-name" @click="toLogin">用户登录</p>
    </div>

    <div class="admin box">
      <img src="/img/home/manageIcon.png" alt="" class="home-img" @click="toAdmin" />
      <p class="logo-name" @click="toAdmin">管理员登录</p>
    </div>

    <div class="signup box">
      <img
        src="/img/home/signupIcon.png"
        alt=""
        class="home-img"
        @click="toSignUp"
      />
...
.login{
  background-image: url(/img/divBg/bg1.jpg);
}

.admin{
  background-image: url(/img/divBg/bg2);
}

.signup{
  background-image: url(/img/divBg/bg3);
}
