...
export default {
  ...
  methods: {
    ...
    borrow() {
      ...
      axios({
        method:"get",
        url:"http://192.168.3.23:8081/user/borrow/",
        params:{
    ...
    searchContent() {
      ...
      axios
        .post(
          // 接口路径是什么？(fixed)
          "http://192.168.3.23:8081/book/list/" + this.inputContent
        )
        .then((res) => {
          console.log("搜索成功");
          let list = res.data;
    ...
    selectByLabel() {
      axios
        .post(
          "http://192.168.3.23:8081/book/list/label",
          {
    ...
    selectByKey() {
      axios
        .get("http://192.168.3.23:8081/book/list/key", {
          params: {
            key: this.key,
          },
        })
