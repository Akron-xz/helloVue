  ...
  <div class="library-container">
    ...
    <div class="borrow-box" v-show="!tableDisplay">
      ...
      <div class="borrow-button">
        <el-button v-if="borrowList.class1 === '借阅' " type="primary" @click="borrow" :class="status">
          已借
        </el-button>
        <el-button v-else-if="borrowList.class1 === '有货' " type="primary" @click="borrow" :class="status">
          有货
        </el-button>
        <el-button v-else="borrowList.class1 === '无货' " type="primary" @click="borrow" :class="status">
          无货
        </el-button>
