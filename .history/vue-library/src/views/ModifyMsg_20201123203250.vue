    ...
    <div class="modify-pwd-box">
      ...
      >
        <el-form-item label="新密码" prop="password">
          <el-input v-model="pwd.newPassword" type="password" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="确认新密码" prop="password">
          <el-input v-model="pwd.checkPassword" type="password" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item>
          <el-button type="primary" @click="submitForm('pwd')"
            >确认</el-button
          >
        </el-form-item>
      </el-form>
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        checkPassword: [{ validator: validatePass,  trigger: "blur", required: true,}],
      },
