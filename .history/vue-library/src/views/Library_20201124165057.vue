  ...
  <div class="library-container">
    ...
    <div class="borrow-box" v-show="!tableDisplay">
      ...
      <div class="borrow-button">
        <el-button v-if="this.bookId == this.return[0].bookId" type="primary" @click="borrow" disabled>
          已借
        </el-button>
        <el-button v-else-if="this.surplusNumber >= 0" type="primary" @click="borrow">
          借阅
        </el-button>
...
export default {
  ...
  created() {
    ...
    axios({
            ...
            this.return[0].bookId = res.data[0].bookId;
            console.log(this.return[0].bookId);
        })
    // 获取图书借阅表borrow表的信息
